...
let calificación = parseInt(prompt("Ingrese la calificacion: "));

if (calificación >= 9.1 && calificación <= 10) {
  alert(`La calificacion es exelente`);
} else if (calificación >= 7.5 && calificación < 8) {
  alert(`La calificacion es muy bien`);
}