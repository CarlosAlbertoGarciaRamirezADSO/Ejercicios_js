...
let chocolate = parseInt(prompt("Ingrese la cantidad de chocolate: "));

let harina = chocolate * 10;

alert(`La cantidad de gramos de harina para hacer el bizcocho es ${harina}`)
